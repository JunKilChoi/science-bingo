...
QUESTIONS = {
    '광합성': [
        ...
        {'q': '광합성에 필요한 기체는 무엇일까요?', 'a': '이산화 탄소'},
        {'q': '광합성이 일어나면 밖으로 나오는 기체는 무엇일까요?', 'a': '산소'},
    ],
    '호흡': [
        {'q': '식물도 낮과 밤에 모두 호흡을 할까요?', 'a': '네. 식물은 낮과 밤에 모두 호흡합니다.'},
        {'q': '식물이 호흡할 때 필요한 기체는 무엇일까요?', 'a': '산소'},
        {'q': '식물이 호흡할 때 필요한 기체는 무엇일까요?', 'a': '산소'},
        {'q': '식물이 호흡하면 어떤 기체가 만들어질까요?', 'a': '이산화 탄소'},
    ],
    '엽록체': [
        {'q': '식물 세포에서 광합성이 일어나는 곳은 어디일까요?', 'a': '엽록체'},
        {'q': '엽록체가 많이 들어 있어 광합성이 활발하게 일어나는 식물의 기관은 무엇일까요?', 'a': '잎'},
        {'q': '엽록체가 특히 많이 들어 있는 식물의 기관은 어디일까요?', 'a': '잎'},
        {'q': '엽록체가 광합성에 이용하는 에너지는 무엇일까요?', 'a': '빛에너지'},
    ],
    '기공': [
        {'q': '기공을 통해 드나드는 기체의 종류를 모두 말하세요', 'a': '산소, 이산화 탄소'},
        {'q': '기공을 통해 광합성에 필요한 어떤 기체가 들어올까요?', 'a': '이산화 탄소'},
        {'q': '기공을 통해 밖으로 나갈 수 있는 광합성 산물 기체는 무엇일까요?', 'a': '산소'},
    ],
    '잎': [
        {'q': '식물에서 광합성이 가장 활발하게 일어나는 기관은 어디일까요?', 'a': '잎'},
        {'q': '잎에서 만든 양분은 잎에서만 다 사용하나요? Yes or No?', 'a': 'No.'},
        {'q': '잎에서 광합성이 활발한 까닭은 어떤 세포 소기관이 많이 있기 때문일까요?', 'a': '엽록체'},
        {'q': '잎에서 기체가 드나드는 작은 구멍을 무엇이라고 할까요?', 'a': '기공'},
    ],
    '빛에너지': [
        {'q': '식물은 광합성에 필요한 에너지를 어디에서 얻을까요?', 'a': '빛'},
        {'q': '마이토콘드리아는 호흡에 빛에너지를 사용할까요?', 'a': 'No.'},
        {'q': '식물은 빛에너지를 이용해 어떤 대표적인 양분을 만들까요?', 'a': '포도당'},
        {'q': '빛이 전혀 없으면 광합성이 일어날 수 있을까요?', 'a': '아니요'},
    ],
    '이산화 탄소': [
        {'q': '식물은 광합성을 할 때 이산화 탄소를 흡수할까요, 방출할까요?', 'a': '흡수합니다.'},
        {'q': '이산화 탄소를 방출하는 곳은 엽록체인가요, 마이토콘드리아 인가요?', 'a': '마이토콘드리아'},
        {'q': '이산화 탄소가 이용되는 식물의 과정은 무엇일까요?', 'a': '광합성'},
        {'q': '세포호흡이 일어나면 이산화 탄소가 만들어질까요?', 'a': '네'},
    ],
    '산소': [
        {'q': '광합성이 일어나면 산소는 흡수될까요, 방출될까요?', 'a': '방출됩니다'},
        {'q': '세포호흡에서 산소는 만들어질까요, 이용될까요?', 'a': '이용됩니다'},
    ],
    '물': [
        {'q': '식물이 물을 이동시키는 통로의 이름은 무엇일까요?', 'a': '물관'},
        {'q': '광합성 과정에서 물은 만들어질까요, 이용될까요?', 'a': '이용됩니다'},
    ],
    '포도당': [
        {'q': '세포호흡에서 포도당은 사용될까요, 만들어질까요?', 'a': '사용됩니다'},
        {'q': '광합성에서 포도당은 사용될까요, 만들어질까요?', 'a': '만들어집니다'},
    ],
    '녹말': [
        {'q': '녹말은 물에 잘 녹을까요, 잘 녹지 않을까요?', 'a': '잘 녹지 않습니다'},
        {'q': '식물은 양분을 저장하기 위해 포도당을 녹말로 바꾸기도 할까요?', 'a': '네'},
    ],
    '설탕': [
        {'q': '식물은 잎에서 만들어진 양분을 다른 기관으로 이동하기 쉬운 형태로 바꿀까요?', 'a': '네'},
        {'q': '잎에서 만들어진 양분이 이동하여 저장될 수 있는 기관을 한 가지 말해 볼까요?', 'a': '뿌리, 줄기, 열매, 씨 등'},
    ],
    '빛의 세기': [
        {'q': '빛의 세기가 강해질수록 광합성량은 끝없이 계속 증가할까요?', 'a': '아니요'},
        {'q': '빛이 전혀 없을 때 광합성이 일어날 수 있을까요?', 'a': '아니요'},
    ],
    '온도': [
        {'q': '온도가 달라지면 광합성량도 달라질 수 있을까요?', 'a': '네'},
        {'q': '광합성량에 영향을 주는 환경 요인을 온도 말고 한 가지 말해 볼까요?', 'a': '빛의 세기 또는 이산화 탄소 농도'},
    ],
    '열매': [
        {'q': '잎에서 만들어진 양분은 열매로 이동할 수 있을까요?', 'a': '네'},
        {'q': '열매에 저장되는 양분은 주로 어느 기관에서 만들어져 올까요?', 'a': '잎'},
    ],
    '소화': [
        {'q': '소화가 진행되면 영양소의 크기는 대체로 커질까요, 작아질까요?', 'a': '작아집니다'},
    ...
    '탄수화물': [
        {'q': '탄수화물이 최종적으로 소화되면 무엇이 될까요?', 'a': '포도당'},
        {'q': '탄수화물의 소화는 어느 곳에서 시작될까요?', 'a': '입'},
    ],
    '단백질': [
        {'q': '단백질이 최종적으로 소화되면 무엇이 될까요?', 'a': '아미노산'},
        {'q': '단백질의 소화가 처음 시작되는 기관은 어디일까요?', 'a': '위'},
    ],
    '지방': [
        {'q': '지방의 소화를 돕는 쓸개즙은 어느 기관에서 만들어질까요?', 'a': '간'},
        {'q': '지방의 소화가 주로 이루어지는 기관은 어디일까요?', 'a': '작은창자'},
    ],
    '위': [
        {'q': '위에서 소화가 시작되는 대표적인 영양소는 무엇일까요?', 'a': '단백질'},
        {'q': '위에서 단백질의 소화를 돕는 대표적인 효소는 무엇일까요?', 'a': '펩신'},
    ],
    '작은창자': [
        {'q': '작은창자 안쪽에서 영양소 흡수를 돕는 돌기 모양 구조는 무엇일까요?', 'a': '융털'},
        {'q': '작은창자에서 흡수된 포도당과 아미노산은 주로 어디로 들어갈까요?', 'a': '혈액'},
    ],
    '혈액': [
    ...
    '폐': [
        {'q': '폐 속에서 실제로 기체 교환이 일어나는 작은 구조는 무엇일까요?', 'a': '허파꽈리'},
    ...
    '콩팥': [
        {'q': '콩팥에서 만들어진 오줌은 어느 기관에 잠시 저장될까요?', 'a': '방광'},
        {'q': '콩팥은 혈액 속 무엇을 걸러내는 데 관여할까요?', 'a': '노폐물'},
    ],
    '동맥': [
        {'q': '동맥의 혈액은 심장에서 멀어지는 방향으로 흐를까요?', 'a': '네'},
        {'q': '동맥과 정맥 사이를 연결하는 매우 가는 혈관은 무엇일까요?', 'a': '모세혈관'},
    ],
    '정맥': [
        {'q': '정맥의 혈액은 어느 기관을 향해 흐를까요?', 'a': '심장'},
        {'q': '정맥의 혈관 벽은 일반적으로 동맥보다 두꺼울까요, 얇을까요?', 'a': '얇습니다'},
    ],
    '허파꽈리': [
        {'q': '허파꽈리 주변에는 어떤 혈관이 많이 분포할까요?', 'a': '모세혈관'},
        {'q': '허파꽈리에서 혈액으로 이동하는 기체는 무엇일까요?', 'a': '산소'},
    ],
    '심방': [
        {'q': '심방에서 혈액은 다음으로 어느 곳으로 이동할까요?', 'a': '심실'},
        {'q': '심방은 심실보다 위쪽에 있을까요, 아래쪽에 있을까요?', 'a': '위쪽'},
    ],
    '심실': [
        {'q': '심실의 벽은 심방의 벽보다 두꺼울까요, 얇을까요?', 'a': '두껍습니다'},
        {'q': '심실에서 나온 혈액은 심장 밖으로 나갈까요, 심장 안으로 들어올까요?', 'a': '심장 밖으로 나갑니다'},
    ],
    '융털': [
        {'q': '융털이 많으면 영양소를 흡수할 수 있는 면적은 넓어질까요, 좁아질까요?', 'a': '넓어집니다'},
        {'q': '융털이 있는 기관은 어디일까요?', 'a': '작은창자'},
    ],
    '방광': [
        {'q': '방광에 저장되는 것은 무엇일까요?', 'a': '오줌'},
        {'q': '방광에 모이기 전에 오줌이 만들어지는 기관은 어디일까요?', 'a': '콩팥'},
    ],
    '모세혈관': [
        {'q': '모세혈관에서는 혈액과 무엇 사이에 물질 교환이 주로 일어날까요?', 'a': '조직 세포'},
